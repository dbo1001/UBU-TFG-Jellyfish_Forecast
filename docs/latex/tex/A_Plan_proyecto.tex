...
\textcolor{red}{tabla en su sitio}
...
%Gráfico
\imagen{Sprint6_BurnDown.png}{\textit{Burndown chart} del Sprint 5}

%Estimación horas
En un principio se estimaron 16 horas y media y finalmente se realizaron 21 horas.

\subsection{Sprint 7 (25/4/2020 - \textcolor{red}{fecha final})}\label{Sprint-5}
...
%Gráfico
\imagen{Sprint7_BurnDown.png}{\textit{Burndown chart} del Sprint 5}

%Estimación horas
En un principio se estimaron XXX horas y se realizaron XXX.
