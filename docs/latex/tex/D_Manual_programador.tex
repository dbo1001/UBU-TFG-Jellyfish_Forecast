...
También se han realizado pruebas del correcto funcionamiento de la aplicación en diferentes navegadores web. Se ha comprobado en Google Chrome, Firefox y Opera.
