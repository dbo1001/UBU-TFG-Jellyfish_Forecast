...
\imagenflotante{descomposicion_series.png}{Descomposición de una serie temporal~\cite{SeriesTemp}.}\label{descomposicion_series}
...
\imagenflotante{estacionariedad_no.png}{Ejemplo de series temporales no estacionarias~\cite{SeriesTempIMG}.}\label{series_no_estacionarias}
...
\imagenflotante{estacionariedad_si.png}{Ejemplo de serie temporal estacionaria~\cite{SeriesTempIMG}.}\label{serie_si_estacionaria}
