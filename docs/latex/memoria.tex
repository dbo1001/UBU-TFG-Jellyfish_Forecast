...
This proyect pretends to aply data minning techniques in order to create a model able to predict new outbreaks based on oceans conditions on the coast of Chile.
